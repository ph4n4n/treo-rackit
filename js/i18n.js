const i18n = {
    vi: {
        ...
        view3DTooltip: 'Chuyển sang xem 3D (3)',
        toggle2DTooltip: 'Quay lại xem 2D (3)',
        ...
        // Canvas instructions
        canvasInstructions: 'Double-click để đặt linh kiện',
        selectToolFirst: 'Chọn công cụ trước, sau đó double-click để đặt',
    ...
    en: {
        ...
        view3DTooltip: 'Switch to 3D view (3)',
        toggle2DTooltip: 'Switch back to 2D view (3)',
        ...
        // Canvas instructions
        canvasInstructions: 'Double-click to place component',
        selectToolFirst: 'Select tool first, then double-click to place',
