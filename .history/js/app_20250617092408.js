class TreoRackitApp {
    ...
    setupToolbar() {
        ...
        document.getElementById('grid-toggle').addEventListener('click', () => {
            ...
            document.getElementById('grid-toggle').classList.toggle('active', this.isGridEnabled);
        });

        // Snap toggle
        document.getElementById('snap-toggle').addEventListener('click', () => {
            this.isSnapEnabled = !this.isSnapEnabled;
            document.getElementById('snap-toggle').classList.toggle('active', this.isSnapEnabled);
        });
    ...
    setupKeyboardShortcuts() {
        document.addEventListener('keydown', (e) => {
            ...
            // Snap toggle with S
            if (e.key === 's' || e.key === 'S') {
                document.getElementById('snap-toggle').click();
            }
        });
    }
